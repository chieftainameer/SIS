 							...
 							//print_r($row);
		      				?>
		      			 	<tr>
		      			 		...
		      			 		<td><button class="btn btn-primary" onclick='approve("<?php echo $row['roll_num'] ?>","<?php echo $row['class'] ?>")'>Approve</button></td>
		      			 	</tr>
		      			<?php endwhile; ?>
		      			<?php else: ?>
		      				<tr>
 							...
 							print_r($row);
		      				?>
		      			 	<tr>
		      			 		...
		      			 		<td><button class="btn btn-primary" onclick='approve("<?php echo $p_row['student_roll_num'] ?>","<?php echo $p_row['class'] ?>")'>Approve</button></td>
		      			 	</tr>
		      			<?php endwhile; ?>
		      			<?php else: ?>
		      				<tr>
		      			...
		      			<td colspan="7">
			      			<ul class="pagination">
			      				<?php for ($i=0; $i < $p_pages ; $i++): ?>
			      					<li class="page-item"><a  class="page-link text-primary" onclick="paginate('parent-table',<?php echo $i ?>,'parents')"><?= $i+1 ?></a></li>
			      				<?php endfor; ?>
			      			</ul>
		      		    </td>
	      		    </tr>
